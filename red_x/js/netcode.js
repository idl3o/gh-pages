...
class NetcodeSDK {
    ...
    return new Promise((resolve, reject) => {
      try {
        ...
        if (typeof io === 'undefined') {
          throw new Error(
            'Socket.io not loaded. Add <script src="/socket.io/socket.io.js"></script> to your HTML.'
          );
        }
  ...
  _attemptReconnect() {
    ...
    this.log(
      `Attempting reconnection in ${delay}ms (attempt ${this.retryCount + 1}/${this.options.maxRetries})`
    );
